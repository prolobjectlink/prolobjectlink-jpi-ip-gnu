...
import io.github.prolobjectlink.prolog.interprolog.gnu.GNUProlog;
import io.github.prolobjectlink.prolog.interprolog.gnu.GNUPrologConverter;
...
public class PrologProviderTest extends PrologBaseTest {
	...
	public final void testToString() {
		...
		assertEquals(GNUProlog.class.getSimpleName() + " [converter=" + GNUPrologConverter.class.getSimpleName() + "]",
				provider.toString());
