 ...
 * @since 1.0
 */
public class GNUProlog extends InterPrologProvider implements PrologProvider {
	...
	public GNUProlog() {
		super(new GNUPrologConverter());
	}

	GNUProlog(PrologConverter<TermModel> converter) {
		super(converter);
	}

	public PrologJavaConverter getJavaConverter() {
		return new GNUPrologJavaConverter(this);
	}

	public PrologEngine newEngine() {
		return new GNUPrologEngine(this);
	}
